...
if __name__ == '__main__':
    ...
    plt.plot(runs_iteration, n2, label='World Clipping')
    plt.plot(runs_iteration, n1, label='Default')
    plt.xlabel('Number of false beliefs')
    plt.ylabel('Number of possible worlds')
    plt.legend(loc="upper left")
    plt.show()

    plt.plot(runs_iteration, t2, label='World Clipping')
    plt.plot(runs_iteration, t1, label='Default')
    plt.xlabel('Number of false beliefs')
